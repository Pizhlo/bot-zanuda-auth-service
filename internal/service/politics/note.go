...
func (s *Service) FilterNotes(ctx context.Context, req model.FilterNotesRequest) (map[int]model.NoteAccessInfo, error) {
	...
	if !spaceAccess.IsMember {
		...
		return map[int]model.NoteAccessInfo{}, service.ErrUserNotMember
	}
