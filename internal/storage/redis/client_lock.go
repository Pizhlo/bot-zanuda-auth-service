...
// lockInfo хранит информацию о блокировке для автоматического обновления TTL.
type lockInfo struct {
	...
	refresh  time.Duration // интервал обновления (обычно ttl / 3)
	stopped  chan struct{}
	stopOnce sync.Once
}
...
func (c *client) SetWithLocking(ctx context.Context, key string, value interface{}, ttl time.Duration) (bool, error) {
...
func (c *client) RefreshLock(ctx context.Context, key string, ttl time.Duration) error {
...
func (c *client) startLockRefresh(ctx context.Context, key string, value interface{}, ttl time.Duration) error {
...
func (c *client) refreshLockLoop(lock *lockInfo) {
